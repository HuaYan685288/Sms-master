<template>
  <div style="">
    <!--个人信息-->
    <el-card class="content" style="width: 60%;margin: 10px">
      <div class="title">
    ...
    <!--饼状图-->
    <el-card class="content" style="width: 36.8%;margin: 10px 10px 10px 0">
    ...
    <!--折线图-->
    <el-card class="content" style="width: 98%;margin: 0 0 10px 10px">
