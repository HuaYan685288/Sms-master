    ...
    <div>
      ...
      <el-row class="info">
        ...
        <el-col :span="8" class="content">
          <el-input-number v-if="userInfo.level === 0" v-model="course.start" controls-position="right" :min="1" :max="20" style="width: 90%;float: left" size="small"></el-input-number>
          <div v-else style="text-align: center">{{course.start}}</div>
        </el-col>
        <el-col :span="2" style="text-align: center"> 至 </el-col>
        <el-col :span="8" style="padding-left: 6px">
          <el-input-number v-if="userInfo.level === 0" v-model="course.end" controls-position="right" :min="1" :max="20" style="width: 90%;float: right"  size="small"></el-input-number>
