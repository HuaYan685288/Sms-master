<template>
  <div class="login" :style="note">
    ...
    <div class="loginForm">
      <el-tabs type="border-card" v-model="tabName" @tab-click="tabClick" style="width:516px ;height: 450px">
        <el-tab-pane label="学生" name="student">
          <Form class="flip" ref="student_tab" :ref-name="'student_tab'"></Form>
        </el-tab-pane>
        <el-tab-pane label="教师" name="teacher">
          <Form ref="teacher_tab" :ref-name="'teacher_tab'"></Form>
        </el-tab-pane>
        <el-tab-pane label="管理员" name="admin">
          <Form ref="admin_tab" :ref-name="'admin_tab'"></Form>
        </el-tab-pane>
        <el-tab-pane label="人脸识别" name="Face">
          <Form ref="Face" :ref-name="'Face'"></Form>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
