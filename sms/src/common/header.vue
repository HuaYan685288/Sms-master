<template>
  <div style="color: white" >
    <img src="../../static/img/logo.svg" alt="" width="270" height="40" style="margin: 10px 50px 10px 50px;float: left" />
    <i class="el-icon-menu collapse" @click="clickCollapse" style="margin-right: 20px;float: left"></i>
    <div class="misName">AI教务系统</div>
      ...
      <div style="float: right;margin-right: 20px;margin-top: 18px;color: white">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item icon="el-icon-setting" @click.native="editPassword" style="width: 100px;"> 修改密码</el-dropdown-item>
            <el-dropdown-item icon="el-icon-switch-button" @click.native="exit"  style="width: 100px;"> 退出登录</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </div>
  ...
  import password from './password/password'
    export default {
        ...
        created() {
            ...
            const date1 = new Date('2024-08-23');
      const date2 = new Date();
      const DAYWeek = 1000 * 60 * 60 * 24*7;
      const diffInDays = Math.round(Math.abs((date2 - date1) / DAYWeek));
            this.day = date +' 第'+ diffInDays+'周'  + week;
        },
        computed: {
          silent: {
            set (newValue) {
