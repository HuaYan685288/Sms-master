package com.yfy.sms.service.User.impl;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.yfy.sms.dao.User.AdminMapper;
import com.yfy.sms.dao.User.StudentMapper;
import com.yfy.sms.dao.User.TeacherMapper;
import com.yfy.sms.dao.User.UserMapper;
import com.yfy.sms.dto.User;
import com.yfy.sms.service.User.UserService;
...
public class UserServiceImpl implements UserService {
  ...
  public User getStudentInfo(Map<String, Object> condition) {
    ...
    System.out.println(userMapper.getAdminInfo(condition));
