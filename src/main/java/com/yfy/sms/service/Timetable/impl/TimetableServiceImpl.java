package com.yfy.sms.service.Timetable.impl;

import com.yfy.sms.dao.CourseInfo.CourseInfoMapper;
import com.yfy.sms.dao.TeacherCourse.TeacherCourseMapper;
import com.yfy.sms.dao.Timetable.TimetableMapper;
import com.yfy.sms.dao.User.StudentMapper;
import com.yfy.sms.dao.WeekCourse.WeekCourseMapper;
import com.yfy.sms.domain.CourseInfo;
import com.yfy.sms.domain.TeacherCourse;
import com.yfy.sms.domain.WeekCourse;
import com.yfy.sms.dto.Timetable;
import com.yfy.sms.dto.User;
import com.yfy.sms.service.Timetable.TimetableService;
  ...
  public List<WeekCourse> getTimetableByTeacher(Map<String, Object> condition) {
    ...
    for (TeacherCourse teacherCourse : list) {
      ...
      for (int i = 0; i < weekCourseList.size(); i++) {
        System.out.println(weekCourseList.get(i));
